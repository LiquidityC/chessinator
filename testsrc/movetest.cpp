...
void MoveTest::test_coordinate_conversion()
{
	...
	cengine::Move m7(0x80, 0x4000);
	CPPUNIT_ASSERT ( m7.get_from_coord() == "h1" );
	CPPUNIT_ASSERT ( m7.get_to_coord() == "g2" );

	cengine::Move m8(0x8000000000000000, 0x40000000000000);
	CPPUNIT_ASSERT ( m8.get_from_coord() == "h8" );
	CPPUNIT_ASSERT ( m8.get_to_coord() == "g7" );
}
